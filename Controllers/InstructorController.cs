...
namespace MVCPrototipo.Controllers
{
    public class InstructorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("InstructorId,Nombre,Apellidos,Grados,FotoPerfil")] Instructor instructor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("InstructorId,Nombre,Apellidos,Grados,FotoPerfil")] Instructor instructor)
        {
